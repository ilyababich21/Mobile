...
import com.example.nivaserviceandroid.viewmodel.telemetryAdapters.HoursDataAdapter;

public class FragmentHours extends Fragment {

    private RecyclerView recyclerView;
    private HoursDataAdapter adapter;
    private MainViewModel mainViewModel;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_engine_hours, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.machine_engine_hours);
        mainViewModel.getMachines().observe(requireActivity(), machineModels -> {
            adapter = new HoursDataAdapter();
