...
import com.example.nivaserviceandroid.viewmodel.telemetryAdapters.AmperageDataAdapter;

public class FragmentAmperage extends Fragment {
    private RecyclerView recyclerView;
    private AmperageDataAdapter adapter;
    private MainViewModel mainViewModel;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_engine_amperage, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.machine_engine_amperage);
        mainViewModel.getMachines().observe(requireActivity(), machineModels -> {
            adapter = new AmperageDataAdapter();
