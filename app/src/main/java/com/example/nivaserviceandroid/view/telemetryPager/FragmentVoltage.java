...
import com.example.nivaserviceandroid.viewmodel.telemetryAdapters.MachineDataAdapter;
import com.example.nivaserviceandroid.viewmodel.MainViewModel;

public class FragmentVoltage extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_high_voltage, container, false);
