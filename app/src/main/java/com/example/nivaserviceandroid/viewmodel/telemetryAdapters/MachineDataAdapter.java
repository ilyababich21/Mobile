...
import com.example.nivaserviceandroid.databinding.AdapterMachineDataBinding;
import com.example.nivaserviceandroid.model.HarvesterModel;

import java.util.ArrayList;

public class MachineDataAdapter extends RecyclerView.Adapter<MachineDataAdapter.ViewHolder> implements Filterable {
    ...
    public MachineDataAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdapterMachineDataBinding binding = DataBindingUtil.inflate(inflater, R.layout.adapter_machine_data,
                parent, false);
        return new ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(MachineDataAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final AdapterMachineDataBinding binding;

        public ViewHolder(AdapterMachineDataBinding binding){
